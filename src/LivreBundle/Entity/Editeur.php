 ...
 * @ORM\Entity(repositoryClass="LivreBundle\Repository\EditeurRepository")
 */
class Editeur
{
    use SynonymeTrait;
     ...
     * Add livre
     *
     * @param \LivreBundle\Entity\BaseLivre $livre
     *
     * @return Editeur
     */
    public function addLivre(\LivreBundle\Entity\BaseLivre $livre)
    {
        $this->livres[] = $livre;
     ...
     * @param \LivreBundle\Entity\BaseLivre $livre
     */
    public function removeLivre(\LivreBundle\Entity\BaseLivre $livre)
    {
